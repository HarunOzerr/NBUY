    ...
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.Property(p => p.DateAdded)
                .HasDefaultValueSql("Date('now')"); //Sqlite ile çalışırken DateTime.Now komutunu kullanma şekli.
                                                    //.HasDefaultValueSql("getdate()") Sql server ile çalışırken DateTime.Now komutunu kullanma şekli.
