...
namespace Proje04_Sayisal_Loto_Oyunu
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ArrayList bilinenler = new ArrayList();//ArrayListlerin kaç elemanlı olacağı söylenmez! İçinde her bir eleman istenilen tipte değer tutabilir.
            ...
            else
            {
                ...
                {
                    Console.WriteLine($"Bildiğiniz Sayılar: {siradakiBilinen} ");
                }
            }
