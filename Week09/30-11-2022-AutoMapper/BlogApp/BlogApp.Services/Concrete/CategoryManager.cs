    ...
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<IResult> Delete(int categoryId, string modifiedByName)
        {
            ...
            if (result)
            {
                ...
                return new Result(ResultStatus.Success, $"{category.Name} kategori başarıyla veri tabanından silinmiştir.");
            }
            return new Result(ResultStatus.Error, "Böyle bir kategori bulunamadı.");
        ...
        public async Task<IResult> HardDelete(int categoryId)
        {
            ...
            {
                var category = await _unitOfWork.Categories.GetAsync(c => c.Id == categoryId);
                await _unitOfWork.Categories.DeleteAsync(category).ContinueWith(c => _unitOfWork.SaveAsync());
                return new Result(ResultStatus.Success, $"{category.Name} kategori başaryıla kalıcı olarak silinmiştir.");
            }
            return new Result(ResultStatus.Error, "Böyle bir kategori bulunamadı.");
        }
    }
