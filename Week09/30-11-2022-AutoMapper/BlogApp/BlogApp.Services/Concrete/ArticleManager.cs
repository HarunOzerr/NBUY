...
namespace BlogApp.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        public async Task<IResult> Add(ArticleAddDto articleAddDto, string createdByName)
        {
            ...
            article.UserId = 1;
            #region Açıklamalar
            // UserId'yi şimdilik el ile veriyoruz. Login işlemlerini tamamladığımızda burayı değiştiriyor olacağız.
            // Eğer entity base içerisinde CreatedDate için default değer vermemiş olsaydık böyle yapabilirdik. Bunun ikinci bir yolu da, profile içinden bu değer vermektir.
