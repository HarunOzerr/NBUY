...
namespace BlogApp.Data.Concrete.EntityFramework.Contexts
{
    public class BlogAppContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            * Bu da güvenlik amacıyla doğrulanmış sertifika gereksinimidir.
            * Bunu ifade eden TrustServerCertificate özelliği, böyle bir sertifika yoksa True'ya çekilmelidir.
            * Çünkü default olarak False'dur.
            * False iken maalesef veri tabanına bağlansa bile kullanım izni vermez.
            */
            #endregion
