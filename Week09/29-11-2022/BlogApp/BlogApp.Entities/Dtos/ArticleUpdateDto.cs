...
namespace BlogApp.Entities.Dtos
{
    public class ArticleUpdateDto
    {
        ...
        [DisplayName("Başlık")]
        [Required(ErrorMessage = "{0} alanı boş geçilmemelidir.")] // 0. İndexteki eleman başa yazılacak. Yani 0. İndexte DisplayName olduğu için içerisindeki ne ise o başa yazılmış olacak.
