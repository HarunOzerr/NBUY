    ...
    public class KitabeviContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kitap>()
                .HasData(
                    new Kitap() {AnaSayfa = true, Id = 1, Ad = "İnsanlar", BasimYili = 2021, SayfaSayisi = 330, KategoriId = 2, YazarId = 1, Ozet = "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor, dignissimos nulla! Possimus mollitia nemo ad voluptate, tempore nobis animi eius assumenda vel pariatur amet, dolorum unde, ut culpa incidunt. Labore."},
                    ...
                    new Kitap() { Id = 5, Ad = "Serenad", BasimYili = 2020, SayfaSayisi = 300, KategoriId = 2, YazarId = 9, Ozet = "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor, dignissimos nulla! Possimus mollitia nemo ad voluptate, tempore nobis animi eius assumenda vel pariatur amet, dolorum unde, ut culpa incidunt. Labore."},
                    new Kitap() { Id = 6, Ad = "19", BasimYili = 2016, SayfaSayisi = 380, KategoriId = 2, YazarId = 6, Ozet = "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor, dignissimos nulla! Possimus mollitia nemo ad voluptate, tempore nobis animi eius assumenda vel pariatur amet, dolorum unde, ut culpa incidunt. Labore."},
