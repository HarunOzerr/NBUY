    ...
    public class EfCoreCardRepository : EfCoreGenericRepository<Card>, ICardRepository
    {
        ...
        public async Task AddToCard(string userId, int productId, int quantity)
        {
            ...
            if (card != null)
            {
                ...
                if (index < 0) //Eğer ürün daha önceden eklenmemişse
                {
                ...
                ShopAppContext.Cards.Update(card); //Her bir user'ın zaten bir kartı var. O karta veri eklediğimiz için update kullanıyoruz.
            }
        }
