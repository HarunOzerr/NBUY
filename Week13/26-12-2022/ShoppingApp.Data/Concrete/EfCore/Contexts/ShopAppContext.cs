...
namespace ShoppingApp.Data.Concrete.EfCore.Contexts
{
    public class ShopAppContext : IdentityDbContext<User, Role, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderItem>() //OrderItem üzerindeki price için ayrı bir config dosyası oluşturabilirdik fakat gerek duymadık. burada direkt olarak bu şekilde sql tarafındaki tipini belirlemiş olduk.
                .Property("Price")
                .HasColumnType("money");
