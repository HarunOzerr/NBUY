-- Products tablosunu Unit Price kolonuna göre büyükten küçüðe sýralayýnýz.

--USE Northwind
--SELECT * FROM Products
--ORDER BY UnitPrice DESC

-- UnitPrice'ý 100 ve üzerinde olan ürünleri listele
--USE Northwind
--SELECT * FROM Products
--WHERE  UnitPrice >=100
...
-- Kategorisi 7 ve 8 olanlardan stok miktarý (UnitsInStock) 10 olan ürünleri listeleyiniz.
--USE Northwind
--SELECT * FROM Products
--WHERE (CategoryID = 7 OR CategoryID = 8) AND UnitsInStock <= 10

-- Kategorisi 7 ve 8 olanlardan stok miktarý (UnitsInStock) 10 olan ürünlerin sayýsý.
--USE Northwind
...
-- Tablolarý birleþtirirken tablonun isminden sonra ona tek harflik bir kýsaltma vererek diðer yerlerde temiz kod olarak kullanabiliriz.
