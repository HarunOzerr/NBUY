...
builder.Services.AddDbContext<IdentityContext>(options => options.UseSqlite("Data Source = ShoppingApp.db")); //Identity contextini dahil ediyoruz.
builder.Services.AddDbContext<ShopAppContext>(); //Kendi veri tabanýmýzý dahil ediyoruz.
