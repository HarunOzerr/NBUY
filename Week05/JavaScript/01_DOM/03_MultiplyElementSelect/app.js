let sonuc;
//getElementByClassName --> Geriye birden çok sonuç döndürebilir.
...
sonuc = document.getElementsByClassName('task')[2].innerText; //innerText detaylı bilgi yerine sadece içeriğini yazdırıyor.
sonuc = document.getElementsByClassName('task');
...
sonuc = document.querySelectorAll('#task-list-2 li'); //Geriye birden çok sonuç döndürür. querySelector olsaydı tek bir sonuç döndürürdü.
